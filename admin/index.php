...
<head>
    ...
    <title>Click & Shop Admin Dashboard</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand fw-bold" href="index.php">Click & Shop</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContentad">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="index.php">Welcome <?php echo $admin_name;?></a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="control">
        <div class="container pt-4 pb-0">
            <div class="categ-header">
                ...
                <h2>Manage Details Of Click & Shop</h2>
            </div>
