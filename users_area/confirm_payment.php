...
if (isset($_GET['order_id'])) {
    $order_id = mysqli_real_escape_string($con, $_GET['order_id']); // Prevent SQL injection
...
// Check if confirm payment form is submitted
if (isset($_POST['confirm_payment'])) {
    ...
    // Check if payment inserted successfully
